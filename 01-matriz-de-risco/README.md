...
🚨 **O gatilho:** o cliente que representa a maior fatia do faturamento passou a exigir **evidência de gestão de riscos de TI formalizada** como condição pra renovar o contrato. O board pediu a entrega em uma semana, antes da reunião com o cliente.
...
| R06 | Recuperação de desastres | Operacional / Disponibilidade | TI + Infraestrutura + Board | Não existe DRP, papéis definidos pra momentos de crise, métricas de RTO/RPO ou alinhamento documentado com o suporte da AWS. |
...
- **R02 e R03, perímetro externo.** O produto é 100% online e o time trabalha de casa sem VPN, então ataques automatizados e interceptação de tráfego são prováveis. Os dois riscos serão **tratados juntos** pra economizar custo e tempo.
...
|---|:---:|:---:|---|---|
| R01 · Gestão de acesso | 5×4 | Mitigar | Levantamento emergencial com o RH pra revogar contas de colaboradores desligados | Política formal de controle de acesso baseada em **RBAC**, com privilégio mínimo |
| R04 · Segurança de dados | 4×5 | Mitigar | Diagnóstico dos bancos pra planejar criptografia em repouso e revisar a rotina de backup | Política de classificação de dados e teste automatizado de restauração de backup |
...
- **Transferir o R06.** A CloudFlux não tem hoje capacidade interna pra desenhar um DRP do zero no curto prazo, então essa construção vai para uma consultoria especializada.
- **Guia consultivo, não imposição.** O plano foi montado junto com a liderança e o time de TI, pra que a diretoria decida de acordo com o orçamento e o apetite a risco da empresa.
...
- Risco residual.
- Um **risk owner** individual pra cada risco (hoje a responsabilidade está atribuída a áreas).
- Data de reavaliação.
